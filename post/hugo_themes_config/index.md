...
### hugo theme's config
```toml
# hugo-theme-meme.toml
##########################################
# 站点配置

baseURL = "https://mmfei.com/"
title = "木木飞"
languageCode = "zh-CN"
hasCJKLanguage = true
# 版权信息（支持 Markdown）
...
[params]
    ...
    ## Gitalk
    enableGitalk = true
    gitalkClientID = "18b19d5b5907429c70ef"
    gitalkClientSecret = "444861d0580bb2a49d81e6e18a2c7bd302668974"
    gitalkRepo = "mmfei.github.io"
    gitalkOwner = "mmfei"
    gitalkAdmin = ["mmfei"]
    gitalkLable = ["Gitalk"]
    ...
    # 跟踪代码的类型
    trackingCodeType = "analytics"
    # 说明：gtag 或 analytics

    trackingID = "G-JC9GDLXKD6"
